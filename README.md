...
- [SandBase CLI](https://github.com/sandbaseai/cli) 🟢 🆓 — MCP onboarding CLI that connects coding agents including Codex, Claude Code, Cursor, Gemini CLI, and OpenCode to 2,000+ AI models, with diagnostics and exact rollback.
